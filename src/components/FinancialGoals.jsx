  ...
  return (
    <div className='w-full'>
      <div className='max-w-[1540px] px-2 py-32 mx-auto'>
        <div className='grid md:grid-cols-2 mx-auto px-2 justify-between'>
            <div 
            data-aos="fade-right"
            data-aos-offset="300"
        ...
        <div className='flex flex-col space-y-12 grid-cols-3'   
            data-aos="fade-left"
            data-aos-offset="300"
            data-aos-easing="ease-in-sine"
            data-aos-duration="1500">
            <h1 className='text-[#172E80] text-[50px] font-medium'>Start the journey to reach your financial goals today.</h1>
